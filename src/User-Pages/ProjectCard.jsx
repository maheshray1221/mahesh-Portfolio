...
export default function ProjectCard({
  ...
  return (
    <div className="w-82 h-130 mt-10 lg:w-110 lg:h-150 border-2 border-white lg:mt-10">
      <div>
        <div ref={cardRef} className="h-50 w-82 lg:h-60 lg:w-110 border cursor-pointer">
          <video
            muted
            loop
            playsInline
      ...
      <div className="ml-2 lg:ml-4">
        ...
        <div className="flex mt-4 gap-5 lg:gap-10 lg:mt-4 ">
          <div className="flex gap-1.5 h-10 w-25 bg-[#ff715b] rounded-lg text-[#121f28] lg:h-10 lg:w-28 ">
            ...
            <a href={live}>
              <button className="lg:text-lg pt-0 lg:pt-1.5 cursor-pointer">Live Link</button>
            </a>
          </div>
          <div className="flex border gap-1.5 h-10 w-25 border-[#ff715b] rounded-lg text-[#ff715b] lg:h-10 lg:w-28">
            ...
            <a href={github}>
              <button className="lg:text-lg pt-0 lg:pt-1 cursor-pointer">Source</button>
            </a>
          </div>
        </div>
      </div>
